        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    <div class="row">
                    <div class="span3">
                        <a class="brand" href="#"><img src="img/ceda.png" alt="logo"></a>
                    </div>    
                      ...
                      <div class="container">
                        ...
                        <div class="nav-collapse collapse" id="nav1">
                           <ul class="nav">
                            ...
                            <!-- Classic dropdown -->
                            <li class="dropdown">
                              <a href="#" class="dropdown-toggle" data-toggle="dropdown"> Training <b class="caret"></b> </a><!-- Training Dropdown -->
                              <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                                <li>
                                  <a tabindex="-1" href="#"> Action </a>
                                </li>
        ...
        <div class="container well well-ceda">
            <div class="row">
                ...
                <div class="carousel-inner">
                    <div class="active item"><img src="img/1101281484C89ekB.jpg"></div>
                    <div class="item"><img src="img/img_1.jpg"></div>
                    <div class="item"><img src="img/img_2.jpg"></div>
                </div>
                <!-- Carousel nav -->
                        ...
                        <hr />
                           ...
                           <div class="span2 pull-left product-image-left-ceda">
                            ...
                            <div class="media-body well">
                                          ...
                                          <br/>
                                          <ul class="media-list">
                                          <li><img src="img/pdf_icon.png"</li>
                                          </ul>
                                          </div>
                                          ...
                                          <h5>details</h5>
                                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</li>
